...
from metaball_viewer.modules.zmq import MetaballSubscriber
from metaball_viewer.utils.log_utils import log_camera, log_metaball, log_state_dict, log_asset
from metaball_viewer.utils.data_utils import parse_data
...
class MetaballVis:
    ...
    def __init__(self) -> None:
        ...
        metaball_mesh_dir = os.path.join(templates_dir, "metaball")
        ...
        metaball_base_dir = os.path.join(templates_dir, "metaball_base")
